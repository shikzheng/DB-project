<?php
    ...
    if (!$connection->connect_errno) {
      ...
      $sql = "SELECT * FROM an_event WHERE start_time < NOW() + INTERVAL 3 DAY AND end_time >= NOW() AND event_id NOT IN (select event_id from sign_up NATURAL JOIN an_event where username = ?)";
